...
import { ShimmerProps, ShimmerDirection } from '../types';
 ...
 */
const getShapeBorderRadius = (shape: 'rectangle' | 'circle' | 'rounded', size: number): number => {
    switch (shape) {
        case 'circle':
            return size / 2;
        case 'rounded':
...
const Shimmer: React.FC<ShimmerProps> = ({
    ...
    const widthStyle: ViewStyle | undefined = typeof width === 'string' && !adaptToContent
